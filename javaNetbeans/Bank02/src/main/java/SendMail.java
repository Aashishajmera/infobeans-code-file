...
public class SendMail {
    ...
    final String USER_NAME = "panchalankit21111999@gmail.com";   //User name of the Goole(gmail) account
  ...
  try {
    ...
    message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("panchalankit21111999@gmail.com")); //Set email recipient
