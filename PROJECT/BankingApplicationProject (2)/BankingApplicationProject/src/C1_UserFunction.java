...
public class C1_UserFunction implements ActionListener {
    ...
    private JButton b1, b2, b3, b4, b5, b6, b7, back, back2;

    public void userfunction() {
        fram6.setTitle("BANKING_APPLICATION");
        ...
        b6 = new JButton("Loan Stetement");
        b6.setFont(new Font("Raleway", Font.BOLD, 18));
        b6.setBounds(400, 260, 250, 50);
    ...
    public void balance() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Account Balance : " + am);
        } catch (Exception e) {
            // JOptionPane.showMessageDialog(null, "Somthinq Want Wrong......");
        }
    }
    ...
    public void actionPerformed(ActionEvent action6) {
        ...
        if (action6.getSource() == b1) {
            ...
            JOptionPane.showMessageDialog(null, "These features will come soon.");
        } else if (action6.getSource() == b4) {
            v.balance();
        } else if (action6.getSource() == b5) {
            t.transectionhistory();
        } else if (action6.getSource() == b6) {
            JOptionPane.showMessageDialog(null, "These features will come soon.");
        } else if (action6.getSource() == b7) {
            up.update();
