...
public class Updatedata implements ActionListener {
    private JFrame fram9 = new JFrame("BANKING_APPLICATION");
    ...
    public void Block() {
        try {
            ...
            if (!acno.matches("^[0-9]+$") || acno.equals("") || acno.length() != 10) {
                JOptionPane.showMessageDialog(null, "Invalid Account Number");
            } else {
    ...
    public void Unblock() {
        try {
            ...
            if (!acno2.matches("^[0-9]+$") || acno2.equals("") || acno2.length() != 10) {
                JOptionPane.showMessageDialog(null, "Invalid Account Number");
            } else {
    ...
    public void Delete() {
        try {
            ...
            if (!acno1.matches("^[0-9]+$") || acno1.length() != 10 || acno1.equals("")) {
                JOptionPane.showMessageDialog(null, "Invalid Account Number");
            } else {
