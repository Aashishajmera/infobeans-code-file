...
public class B_AdminLogin implements ActionListener {
    ...
    public void adminlogin() {
        fram2.setTitle("BANKING_APPLICATION");
    ...
    public void actionPerformed(ActionEvent action2) {
        if (action2.getSource() == login) {
            ...
            if (a_id.equals("") || a_id.equals(null) || a_password.equals("") || a_password.equals(null)) {
                JOptionPane.showMessageDialog(null, "Plese Enter ID and Password");
            } else if (!a_id.matches("^[0-9]+$")) {
                JOptionPane.showMessageDialog(null, "Enter Only Numbers In ID");
            } else if (a_id.length() != 4) {
                JOptionPane.showMessageDialog(null, "Please Enter Only 4 Digit ID Number");
