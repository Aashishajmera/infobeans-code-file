...
public class SendMail {
    ...
    public static void main(String[] args) {
        ...
        email.createAndSendEmail("risingstarsbank@gmail.com", "Create bank account ",
                " Dear customer, \n Congratulations your account has been successfully created in RS BANK Account Number and PIN  Warning !! Do not share your pin number");
    }
    ...
    private void sendEmailMessage() {
        ...
        try {
            ...
            message.setRecipients(Message.RecipientType.TO, InternetAddress.parse("raj@gmail.com")); // Set email
                                                                                                     // recipient
